...
class Parking {
  constructor() {
      this.enterBtn = document.getElementById('btnnew');
      this.parkBtn = document.getElementById('btnpark');
      this.parkInput = document.getElementById('placePark');
      this.leaveBtn = document.getElementById('btnleave');
      this.leaveInput = document.getElementById('placeLeave');
  }
